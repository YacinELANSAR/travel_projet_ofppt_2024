...
<head>
    ...
    <link rel="stylesheet" href="frontend/css/adminHotelandRestaurant.css" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-G3sMXJuQ+lkLmAgHl0el5Ge8FkMhfyMEuC/Yb8khLP0o21HzjNv6Ita4FZKDAzV3" crossorigin="anonymous">
        ...
        <div id="sidebar">
            <div class="sidebar__title">
                <div class="sidebar__img">
                    <h1 class="text-center fs-2">Travelino</h1>
                </div>
            ...
            <div class="sidebar__menu">
                ...
                <a href="{{route('adminHotels.index')}}">Gestion des admins des hotels</a>
                </div>
                <div class="sidebar__link" style="display: flex;">
                <svg style="background-color: white; width:30px;height:30px;padding:6px;border-radius:5px;margin-right:6px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M96 128a128 128 0 1 0 256 0A128 128 0 1 0 96 128zm94.5 200.2l18.6 31L175.8 483.1l-36-146.9c-2-8.1-9.8-13.4-17.9-11.3C51.9 342.4 0 405.8 0 481.3c0 17 13.8 30.7 30.7 30.7H162.5c0 0 0 0 .1 0H168 280h5.5c0 0 0 0 .1 0H417.3c17 0 30.7-13.8 30.7-30.7c0-75.5-51.9-138.9-121.9-156.4c-8.1-2-15.9 3.3-17.9 11.3l-36 146.9L238.9 359.2l18.6-31c6.4-10.7-1.3-24.2-13.7-24.2H224 204.3c-12.4 0-20.1 13.6-13.7 24.2z"/></svg>                    
                <a href="{{route('adminRestaurants.index')}}">Gestion des admins des restaurants</a>
                </div>
                <div class="sidebar__link" style="display: flex;">
                <svg style="background-color: white; width:30px;height:30px;padding:6px;border-radius:5px;margin-right:6px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M64 0C28.7 0 0 28.7 0 64V352c0 35.3 28.7 64 64 64h96v80c0 6.1 3.4 11.6 8.8 14.3s11.9 2.1 16.8-1.5L309.3 416H448c35.3 0 64-28.7 64-64V64c0-35.3-28.7-64-64-64H64z"/></svg>                    
                <a href="{{route('contacts.index')}}">Messages des clients</a>
                </div>
